...
Every `⇧J`/`⇧K` press also flashes a brief `▲`/`▼` in the row's right margin on whichever row(s) just moved (sessions, windows, and groups alike), fading out after about a second.
